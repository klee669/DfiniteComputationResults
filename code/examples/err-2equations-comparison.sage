...
interval1 = [RBF(RealInterval(0.480323,0.48032)),RBF(RealInterval(1.941467,1.941465)),RBF(RealInterval(0.503039,0.503037)),RBF(RealInterval(0.993962,0.993960))]
interval2 = [RBF(RealInterval(0.48034,0.48031)),RBF(RealInterval(1.94148,1.94146)),RBF(RealInterval(0.50305,0.50303)),RBF(RealInterval(0.99397,0.99395))]
interval3 = [RBF(RealInterval(0.4805,0.4802)),RBF(RealInterval(1.9417,1.9414)),RBF(RealInterval(0.5031,0.5029)),RBF(RealInterval(0.9940,0.9939))]
...
interval6 = [RBF(RealInterval(0.4,0.5)),RBF(RealInterval(1.9,2)),RBF(RealInterval(0.5,0.6)),RBF(RealInterval(0.9,1))]
interval = [interval1, interval2, interval3, interval4, interval5, interval6]
...
print table([(6-i, k[i][0][0].endpoints()[0]>interval[i][0].endpoints()[0] and k[i][0][0].endpoints()[1]<interval[i][0].endpoints()[1]
              ...
              and k[i][3][0].endpoints()[0]>interval[i][3].endpoints()[0] and k[i][3][0].endpoints()[1]<interval[i][3].endpoints()[1],(beta(sys, varlist, explist, inilist, point[i],iniAt) * gammaValue(sys,varlist,explist,inilist,rad, point[i],iniAt,1e-40)).n() < ((13-3*sqrt(17))/4).n())  for i in [0..5]], header_row=["decimal places", r"krawczyk",r"alpha"], frame=True)
