...
print table([(point,i*0.005,b*(gammaValue(sys,varlist,explist,inilist,i*0.005, point, iniAt, 1e-40)).n()) for i in range(1,2)], header_row=["point",r"radius", r"alpha"], frame=True)
